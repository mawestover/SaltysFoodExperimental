...
{
    internal class NachosItemGroupView : ItemGroupView
    {
        internal void Setup(GameObject prefab)
        {
            ComponentGroups = new()
            {
                ...
                ,new()
                {
                    GameObject = GameObjectUtils.GetChildObject(prefab, "Beef"),
                    Item = (Item)GDOUtils.GetCustomGameDataObject<BeefTacoPortion>().GameDataObject
                },
                new()
                {
