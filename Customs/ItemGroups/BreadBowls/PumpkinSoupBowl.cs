...
{
    internal class PumpkinSoupBowl : CustomItemGroup<ItemGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PumpkinSoupBowl";
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Pumpkin Soup Bowl").AssignMaterialsByNames(); //Mod.Bundle.LoadAsset<GameObject>("Carrot Bowl");
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>
        {
            ...
            new ItemGroup.ItemSet
            {
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetExistingGDO(ItemReferences.ServedSoupPumpkin)
                },
                Min = 1,
                Max = 1
            }
