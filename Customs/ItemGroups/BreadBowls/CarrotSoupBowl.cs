...
{
    internal class CarrotSoupBowl : CustomItemGroup<ItemGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "CarrotSoupBowl";
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Carrot Bowl").AssignMaterialsByNames(); //Mod.Bundle.LoadAsset<GameObject>("Carrot Bowl");
        ...
        public override ItemValue ItemValue => ItemValue.VeryHigh;
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>
        {
            ...
            new ItemGroup.ItemSet
            {
                ...
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetCustomGameDataObject<SaltysBreadBowl>().GameDataObject
                },
            ...
            new ItemGroup.ItemSet
            {
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetExistingGDO(ItemReferences.ServedSoupCarrot)
                },
                Min = 1,
                Max = 1
            }
