...
{
    internal class PlatedBroccoliCheeseSoupBowl : CustomItemGroup<PlatedBreadBowlCheeseView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PlatedBroccoliCheeseSoupBowl";
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Plated Broccoli Soup").AssignMaterialsByNames();
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>
        {
            ...
            new ItemGroup.ItemSet
            {
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetCustomGameDataObject<BroccoliCheeseSoupBowl>().GameDataObject,
                },
                Min = 1,
                Max = 1
            }
        ...
        public override void OnRegister(ItemGroup gameDataObject)
        {
            ...
            Prefab.GetComponent<PlatedBreadBowlCheeseView>()?.Setup(Prefab);            
        }
