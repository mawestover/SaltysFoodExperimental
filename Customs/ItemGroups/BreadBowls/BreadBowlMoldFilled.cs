...
using SaltysFood.Customs.ItemGroups.BreadBowls;
using UnityEngine;

namespace SaltyFood.Customs.ItemGroups
{
    internal class BreadBowlMoldFilled : CustomItemGroup<BreadBowlMoldView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "BreadBowlMoldFilled";
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Bread Bowl Mold").AssignMaterialsByNames();
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>
        {
            ...
            new ItemGroup.ItemSet
            {
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetExistingGDO(ItemReferences.Dough)
                },
                Min = 1,
                Max = 1
            }
        ...
        public override List<Item.ItemProcess> Processes => new List<Item.ItemProcess>
        {
            new Item.ItemProcess
            {
                ...
                Duration = 6,
                Result = (Item)GDOUtils.GetCustomGameDataObject<CookedBreadBowlMoldFilled>().GameDataObject
            }
        };
        ...
        public override void OnRegister(ItemGroup gameDataObject)
        {
            ...
            Prefab.GetComponent<BreadBowlMoldView>()?.Setup(Prefab);
        }
    }
}