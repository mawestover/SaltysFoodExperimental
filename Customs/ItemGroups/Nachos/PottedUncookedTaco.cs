...
{
    public class PottedUncookedTaco : CustomItemGroup<ItemGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PottedUncookedTaco";
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Potted UncookedTaco").AssignMaterialsByNames();
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>
        {
            ...
            new ItemGroup.ItemSet
            {
                ...
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetCustomGameDataObject<PottedUncookedBeef4>().GameDataObject
                },
        ...
        public override List<Item.ItemProcess> Processes => new List<Item.ItemProcess>
        {
            new Item.ItemProcess
            {
                ...
                Duration = 3,
                Result = (Item)GDOUtils.GetCustomGameDataObject<PottedCookedTaco>().GameDataObject
            }
        };
        public override void OnRegister(ItemGroup gameDataObject)
        {
            ...
            Prefab.ApplyMaterialToChild("Patty4/Steak_Cooked", "Raw Burger");
        }
    }
}