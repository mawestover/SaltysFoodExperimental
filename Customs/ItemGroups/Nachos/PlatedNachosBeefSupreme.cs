...
{
    internal class PlatedNachosBeefSupreme : CustomItemGroup<NachosBeefSupremeGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PlatedNachosBeefSupreme";
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>
        {
            ...
            new ItemGroup.ItemSet
            {
                ...
                Items = new List<Item>
                {
                    // GDOUtils.GetExistingGDO(ItemReferences.Plate) - This is a helper method that gets a reference to a vanilla Item.
                     (Item)GDOUtils.GetCustomGameDataObject<PlatedNachosNBeef>().GameDataObject,
                },
            ...
            new ItemGroup.ItemSet
            {
                Items = new List<Item>
                {
                    ...
                    (Item)GDOUtils.GetCustomGameDataObject<Guacamole>().GameDataObject,
        ...
        public override void OnRegister(ItemGroup gameDataObject)
        {
            ...
            Prefab.GetComponent<NachosBeefSupremeGroupView>()?.Setup(Prefab);
