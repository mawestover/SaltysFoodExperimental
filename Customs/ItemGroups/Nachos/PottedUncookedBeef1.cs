...
{
    public class PottedUncookedBeef1 : CustomItemGroup<ItemGroupView>
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PottedUncookedBeef1";
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Potted UncookedBeef1").AssignMaterialsByNames();
