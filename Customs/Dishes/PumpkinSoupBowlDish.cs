...
namespace SaltyFood.Customs.Dishes
{
    public class PumpkinSoupBowlDish : CustomDish
    {
        ...
        public override List<Dish.MenuItem> ResultingMenuItems => new List<Dish.MenuItem>
        {
            new Dish.MenuItem
            {
                Item = (Item)GDOUtils.GetCustomGameDataObject<PlatedPumpkinSoup>().GameDataObject,
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new List<(Locale, UnlockInfo)>
        {
            ...
            {
                Name = "Pumpkin Soup Bowls",
                Description = "Adds soups as mains (with bread bowls)",
                FlavourText = ""
            })
        };
    }
