...
namespace SaltyFood.Customs.Dishes
{
    public class TomatoSoupBowlDish : CustomDish
    {
        ...
        public override List<Dish.MenuItem> ResultingMenuItems => new List<Dish.MenuItem>
        {
            new Dish.MenuItem
            {
                Item = (Item)GDOUtils.GetCustomGameDataObject<PlatedTomatoSoup>().GameDataObject,
