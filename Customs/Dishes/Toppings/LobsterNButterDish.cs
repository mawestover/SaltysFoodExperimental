...
namespace SaltyFood.Customs.Dishes
{
    public class LobsterNButterDish : CustomDish
    {
        ...
        public override List<Unlock> HardcodedRequirements { get => new List<Unlock>() { (Dish)GDOUtils.GetCustomGameDataObject<LobsterDish>().GameDataObject }; }
        ...
        public override List<Dish.MenuItem> ResultingMenuItems => new List<Dish.MenuItem>
        {
            new Dish.MenuItem
            {
                Item = (Item)GDOUtils.GetCustomGameDataObject<PlatedLobsterNButter>().GameDataObject,
        ...
        {
            { Locale.English, "Combine 4 butter blocks in a pot with crushed garlic and cook." }
        };
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new List<(Locale, UnlockInfo)>
        {
            ...
            {
                Name = "Lobster With Butter",
                Description = "Adds Garlic Butter Topping",
                FlavourText = ""
            })
        };
    }
