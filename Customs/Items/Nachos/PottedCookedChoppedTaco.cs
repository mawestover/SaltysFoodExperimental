...
{
    public class PottedCookedChoppedTaco : CustomItem
    {
        // UniqueNameID - This is used internally to generate the ID of this GDO. Once you've set it, don't change it.
        public override string UniqueNameID => "PottedCookedChoppedTaco";
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Potted CookedTaco").AssignMaterialsByNames();
        ...
        public override Item SplitSubItem => (Item)GDOUtils.GetCustomGameDataObject<BeefTacoPortion>().GameDataObject;
