...
namespace SaltyFood.Customs.Items
{
    public class Guacamole : CustomItem
    {
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Guacamole").AssignMaterialsByNames();
