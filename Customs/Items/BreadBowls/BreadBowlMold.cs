...
namespace SaltyFood.Customs.Items
{
    public class BreadBowlMold : CustomItem
    {
        ...
        public override Appliance DedicatedProvider => (Appliance)GDOUtils.GetCustomGameDataObject<BreadBowlProvider>().GameDataObject;
    }
}