...
namespace SaltyFood.Customs.Items
{
    public class SaltysBreadBowl : CustomItem
    {
        ...
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("Bread Bowl").AssignMaterialsByNames();
